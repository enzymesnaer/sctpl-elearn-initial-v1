      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
          <ul class="nav navbar-nav navbar-right hidden-sm hidden-xs">
            <li style="margin-left:-10px;padding-left:3px;"><a href="https://datascience.suvenconsultants.com#datascience" class="head_panel" style="font-size:14px">Data-Science</a></li>
            <li style="margin-left:-10px;padding-left:3px;"><a href="https://datascience.suvenconsultants.com#sql" class="head_panel" style="font-size:14px">SQL</a></li>
            <li style="margin-left:-10px;padding-left:3px;"><a href="https://datascience.suvenconsultants.com#dataanalytics" class="head_panel" style="font-size:14px">Data-Analytics</a></li>
            <li style="margin-left:-10px;padding-left:3px;"><a href="https://datascience.suvenconsultants.com#statistics" class="head_panel" style="font-size:14px">Statistics</a></li>
            <li style="margin-left:-10px;padding-left:3px;"><a href="https://datascience.suvenconsultants.com#python" class="head_panel" style="font-size:14px">Python</a></li>
            <li style="margin-left:-10px;padding-left:3px;"><a href="https://datascience.suvenconsultants.com#ml" class="head_panel" style="font-size:14px">ML</a></li>
            <li style="margin-left:-10px;padding-left:3px;"><a href="https://datascience.suvenconsultants.com#advml" class="head_panel" style="font-size:14px">Adv. ML</a></li>
          </ul>
          <ul class="nav navbar-nav navbar-right hidden-lg hidden-md">
            <li style="margin-top:-2px;"><a href="https://datascience.suvenconsultants.com#datascience" class="head_panel" style="font-size:14px">Data-Science</a></li>
            <li style="margin-top:-5px;"><a href="https://datascience.suvenconsultants.com#sql" class="head_panel" style="font-size:14px">SQL</a></li>
            <li style="margin-top:-5px;"><a href="https://datascience.suvenconsultants.com#dataanalytics" class="head_panel" style="font-size:14px">Data-Analytics</a></li>
            <li style="margin-top:-5px;"><a href="https://datascience.suvenconsultants.com#statistics" class="head_panel" style="font-size:14px">Statistics</a></li>
            <li style="margin-top:-5px;"><a href="https://datascience.suvenconsultants.com#python" class="head_panel" style="font-size:14px">Python</a></li>
            <li style="margin-top:-5px;"><a href="https://datascience.suvenconsultants.com#ml" class="head_panel" style="font-size:14px">ML</a></li>
            <li style="margin-top:-5px;"><a href="https://datascience.suvenconsultants.com#advml" class="head_panel" style="font-size:14px">Adv. ML</a></li>
          </ul>
        </div>
      </div>
    </nav>
