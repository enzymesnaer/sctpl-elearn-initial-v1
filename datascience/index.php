      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
          <ul class="nav navbar-nav navbar-right hidden-sm hidden-xs">
            <li  style="margin-left:-10px;padding-left:-3px;" class=""><a href="https://datascience.suvenconsultants.com/elearning/" class="head_panel" style="font-size:17px;letter-spacing: 1px;"><button style="margin-top:-8px;background-color:transparent;border-radius:4px;padding:8px; border: solid 1.5px white;"><b class="">eLearning</b></button></a></li>
          ...
          <ul class="nav navbar-nav navbar-right hidden-lg hidden-md">
            <li style="margin-top:-2px;" class=""><a href="https://datascience.suvenconsultants.com/elearning/" class="head_panel" style="font-size:17px;"><b>eLearning</b></a></li>
            <li  style="margin-left:-10px;padding-left:3px;"><a href="https://datascience.suvenconsultants.com/interviews/" class="head_panel" style="font-size:14px;letter-spacing: 1px;">Interview Prep</a></li>
              ...
              <div class="col-lg-7 col-md-7  " style="padding:50px;margin-top:-20px;">
                ...
                <p style="color: white;margin-top:-21px;"><h1 style="color: white;font-weight:580;letter-spacing:-1px;">Masters in Data Science Programme</h1>
                  ...
                  <ul class="pseudo-ul" style="color: white;margin-left:0px;"><p style="text-decoration:underline;"><h3 style="color: white;font-weight:bold;">Course Highlights:</h3></p>
                    ...
                    <br>
                    <center><h3 style="color: white;font-weight:bold;margin-left:-70px;margin-top:-10px;"> Total Fee : INR <span class="strikethrough-diagonal">47000</span> 43000/-</h3></center>
                  </ul>
                </p>
                <div class="row" style="">
            ...
            <div class="container">
              ...
              <div class="row" style=":-110px;">
                <div class="testimonial-part">
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 text-right" style=":100px;90px;">
                    <img class="img-circle" src="https://datascience.suvenconsultants.com/elearning/assets/imgm/kranjekar.jpg" style="width: 110px;height:110px;">
                  </div>

                  <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12" style="width:40%;">
                    <div class="comment-box2" style="margin-left:-70px;margin-right:30px;padding:5px;padding-bottom:10px;min-height: 85px;max-height: 85px;">
                      <p class="" style="font-size:13px;">
                      <b>Hoshang Karanjekar</b> : <b>Software Engineer</b> working for Viacom18 Media Pvt Ltd with MTech in Computer Science specializing in AI domain. A problem solver on kaggle. Specializes in FLASK, AWS and deploying ML models on the cloud.
                      </p>
                    </div>
                  </div>
...
(*Python for Data Science is covered under "Machine Learning course" module)</li><br>
                    ...
                    <center><h4 style="color: white;font-weight:bold;margin-left:-50px;margin-top:-10px;"> Fee (only for Python) : INR 9000/-</h4></center>
                  </ul>
                </p>
                <div class="row" style="">
                  <div class="col-lg-4 col-md-4"></div>
